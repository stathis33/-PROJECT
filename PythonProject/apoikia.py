...
class Game:
    def __init__(self):
        ...
        self.resource_images = {
            'wood': pygame.image.load('texnologia-upologismou/PythonProject/wood.png'),
            'wheat': pygame.image.load('texnologia-upologismou/PythonProject/wheat.png'),
            'ore': pygame.image.load('texnologia-upologismou/PythonProject/ore.png'),
            'brick': pygame.image.load('texnologia-upologismou/PythonProject/ore.png'),
            'sheep': pygame.image.load('texnologia-upologismou/PythonProject/sheep.png')
        }
